...
flags.DEFINE_string("project_name", "kuhn-poker", "project name of wandb")
...
def main(_):
  ...
  # sq_form_solver = mommwu_dilated.MMDDilatedEnt(game, FLAGS.alpha, stepsize=2, beta=0.1, itv=50)
